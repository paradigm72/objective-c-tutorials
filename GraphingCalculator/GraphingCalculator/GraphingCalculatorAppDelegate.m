...
//  GraphingCalculator
//
//  Created by Paul Romine on 2/28/14.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	UINavigationController *myNC = [[UINavigationController alloc] init];
	CalculatorViewController *cvc = [[CalculatorViewController alloc] init];
	myNC.navigationBarHidden = YES;
	[myNC pushViewController:cvc animated:NO];
	[cvc release];
	
	[self.window addSubview:myNC.view];
